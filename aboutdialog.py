...
class Ui_aboutDialog(object):
    def setupUi(self, aboutDialog):
        ...
        self.line.setGeometry(QtCore.QRect(140, 200, 321, 20))
        ...
        self.bgArtLabel.setPixmap(QtGui.QPixmap(":/icons/sb_dialog.png"))
